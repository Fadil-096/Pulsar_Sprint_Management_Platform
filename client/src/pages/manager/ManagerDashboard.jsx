    ...
    <div>
      <div className="page-header flex flex-col md:flex-row justify-between items-start md:items-end gap-4 mb-5">
        ...
        <div className="flex flex-col sm:flex-row items-end sm:items-center gap-3">
          ...
          {isCompleted && (
            <button onClick={() => navigate('/manager/reports?sprint_id=' + selectedSprintId)} className="bg-bg-card border border-line text-accent-blue font-medium text-sm px-4 py-2 rounded-2xl hover:bg-bg-secondary transition-colors shadow-sm whitespace-nowrap">
